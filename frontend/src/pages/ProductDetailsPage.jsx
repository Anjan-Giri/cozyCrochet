...
//           const productName = name.replace(/-+/g, " ").trim().toLowerCase();
...
//         // If not in Redux or Redux is empty, use the search endpoint
...
//           setData(data.products[0]); // Get the first matching product
